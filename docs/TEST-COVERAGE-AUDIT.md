...
2. **Native coverage instrumentation** — JaCoCo on the Robolectric tier, `-enableCodeCoverage` on the XCTest tier. The web bridge is instrumented and ratcheted as of `0.2.0`; the natives are not.
